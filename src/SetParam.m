...
Data.fold_int = 5;% 0.9 of data selected for traing, further divided to internal train and test
Data.nchoos = 2;% number of combinations of small selected features
Data.c1_sizeTrain = floor(Data.train_percent*Data.c1_size)+1;
Data.c2_sizeTrain = floor(Data.train_percent*Data.c2_size);
